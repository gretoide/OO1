...
public class AlquilerDePropiedades {
	...
	public Propiedad registrarPropiedad(String unNombre, String unaDescripcion, String unaDireccion, 
											double precioPorNoche, Usuario unPropietario, PoliticaDeDevolucion politica){
		Propiedad unaPropiedad = new Propiedad(unNombre, unaDescripcion, unaDireccion, 2.200, unPropietario, politica);
	...
	public double devolucion(PoliticaDeDevolucion politica, Reserva reserva, LocalDate fecha) {
		return politica.calcularDevolucion(reserva, fecha);
	}
